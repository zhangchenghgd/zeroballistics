...
namespace
{
    ...
    float D3DXVec3Dot( const D3DXVECTOR3 * v1, const D3DXVECTOR3 * v2)
    {
        return v1->x*v2->x + v1->y*v2->y + v1->z*v2->z;
    }

    void D3DXVec3Cross ( D3DXVECTOR3 * ret, const D3DXVECTOR3 * v1, const D3DXVECTOR3 * v2)
    {
    ...
    D3DXVECTOR3 operator*(float f, const D3DXVECTOR3 & v)
    {
        return D3DXVECTOR3(v.x*f, v.y*f, v.z*f);
    }
