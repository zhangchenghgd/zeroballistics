...
# everything is lost at this point, start anew
...
def fileCallback(filename):
    ...
    for p in os.listdir(blend_dir):
        ...
        filename = complete_path.replace("\\", "/")
        script_file.write(_EXPORT_HELPER_SCRIPT.
                          replace("logfilename", "\"" + log_path + "\"").
        ...
        execCmd( config["blender_executable_file"], "-b -P " + path)
