...
//------------------------------------------------------------------------------
template<typename T>
inline bool loadArrayElement(std::istream & stream, T & element)
{
...
//------------------------------------------------------------------------------
template<>
inline bool loadArrayElement<std::string>(std::istream & stream, std::string & str)
{
    str = "";
    
    std::string sub_str;
    while (stream >> sub_str)
    {
        if (!str.empty()) str += ' ';
        str += sub_str;
    }
...
std::istream & operator>>(std::istream & in, std::vector<T> & array)
{
    ...
    while (!tokenizer.isEmpty())
    {
        ...
        T array_element;
        if (! loadArrayElement(str_stream, array_element)) break;
