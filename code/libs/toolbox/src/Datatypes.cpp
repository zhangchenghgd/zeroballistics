...
//------------------------------------------------------------------------------
/***
  * Caution on values smaller 17(dec) they will produce only one character
  * therefore an additional zero is added so that the string is formatted
  * correctly.
  **/
std::string Color::getHexString(bool with_alpha)
{
    int a = (int)(a_ * 255.0f);
    int r = (int)(r_ * 255.0f);
    int g = (int)(g_ * 255.0f);
