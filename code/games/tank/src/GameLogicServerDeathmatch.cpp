 ...
 *  for this logic
 */
AIPlayer * GameLogicServerDeathmatch::createAIPlayer() const
{
    return new AIPlayerDeathmatch(puppet_master_);
}

//------------------------------------------------------------------------------
void GameLogicServerDeathmatch::doHandleLogic(float dt)
{
