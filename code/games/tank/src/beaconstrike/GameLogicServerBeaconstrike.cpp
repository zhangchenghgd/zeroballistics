...
Matrix GameLogicServerBeaconstrike::getRespawnPos(const SystemAddress & pid, unsigned stage)
{
    ...
    if (!team)
    {
        Exception e;
        e << pid
          << " is assigned to no team in GameLogicServerBeaconstrike::getRespawnPos.\n";
        throw e;
    }
...
//------------------------------------------------------------------------------
void GameLogicServerBeaconstrike::onInstantWeaponHit(InstantHitWeapon * gun,
                                                     RigidBody * hit_object)
{
...
//------------------------------------------------------------------------------
void GameLogicServerBeaconstrike::onPlayerTeamChanged(ServerPlayer * player)
{
 ...
 *  for this logic
 */
AIPlayer * GameLogicServerBeaconstrike::createAIPlayer() const
{
    return NULL;
} 

//------------------------------------------------------------------------------
void GameLogicServerBeaconstrike::doHandleLogic(float dt)
{
