...
OutputBaseFilename=SetupZB_v1.10_soccer
Compression=lzma
SolidCompression=yes
LicenseFile=..\SW_Deployment_WIN32\eula.txt
PrivilegesRequired=admin

[Files]
Source: "..\SW_Deployment_WIN32\*"; DestDir: "{app}"; Permissions: admins-full users-modify authusers-modify everyone-modify;
Source: "..\SW_Deployment_WIN32\data\*"; DestDir: "{app}\data\"; Flags: recursesubdirs createallsubdirs; Permissions: admins-full users-modify authusers-modify everyone-modify;
