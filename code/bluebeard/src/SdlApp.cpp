...
//------------------------------------------------------------------------------
void SdlApp::toggleFullScreenIfEnabled()
{
#ifdef _WIN32  
    s_log << Log::warning
...
void SdlApp::createSdlSurface()
{
    ...
    // delay fullscreen switch until after registration on linux
    bool switch_fullscreen = false;
#ifdef _WIN32
    switch_fullscreen = s_params.get<bool>(application_section_ + ".app.fullscreen");
#endif
