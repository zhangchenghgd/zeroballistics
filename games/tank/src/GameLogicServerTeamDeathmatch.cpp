...
void GameLogicServerTeamDeathmatch::loadLevel(const std::string & name)
{
    ...
    s_scheduler.addTask(PeriodicTaskCallback(this, &GameLogicServerTeamDeathmatch::handleLogic),
                        1.0f / s_params.get<float>("server.logic.logic_fps"),
                        "GameLogicServerTeamDeathmatch::handleLogic",
                        &fp_group_);    
}
...
//------------------------------------------------------------------------------
void GameLogicServerTeamDeathmatch::onPlayerTeamChanged(Player * player)
{
}
...
//------------------------------------------------------------------------------
void GameLogicServerTeamDeathmatch::handleLogic(float dt)
{
