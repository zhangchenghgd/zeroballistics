...
//------------------------------------------------------------------------------
void Beacon::readInitValuesFromBitstream(RakNet::BitStream & stream, GameState * game_state)
{
...
Beacon::Beacon() :
    ...
    state_(BS_DISPENSED)
{
    addStateObserver(ObserverCallbackFun0(this, &Beacon::setNetworkFlagDirty));
