...
//------------------------------------------------------------------------------ 
class SetPlayerDataCmd : public NetworkCommandClient
{
 public:
    SetPlayerDataCmd(const SystemAddress & player_id);
    SetPlayerDataCmd(const std::string & name, uint32_t player_id, uint32_t session_key);
