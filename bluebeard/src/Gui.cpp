...
void Gui::init(int width, int height)
{
    ...
    // cegui throws if log file cannot be written...
    // we could also implement a custom logger...
    ...
    cegui_system_->subscribeEvent(CEGUI::System::EventGUISheetChanged, CEGUI::SubscriberSlot(&Gui::onGuiSheetChanged, this));
