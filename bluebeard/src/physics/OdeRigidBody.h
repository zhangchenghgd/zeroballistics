...
class OdeRigidBody
{
 ...
 public:
    ...
    void changeSpace(OdeCollisionSpace * new_space);
    ...
    void setActivationPoints(unsigned p);
    bool dealActivation(unsigned d);
    unsigned getLifetime() const;

    bool isClientSideOnly() const;

    bool isAlignCogSet() const;
