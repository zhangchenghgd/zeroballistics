...
void Shadow::initShadowCamera()
{
    ...
    camera_stateset->setAttribute(s_scene_manager.getCachedProgram("shadow"), osg::StateAttribute::OVERRIDE);


    // .. or textures.
    for (unsigned i=0; i<8; ++i)
    {
        camera_stateset->setTextureAttribute(i, NULL, osg::StateAttribute::OVERRIDE);
    }
